...
<script type="text/javascript" src="../js/product/register.js"></script>
<div id="main-wrap">
	<aside>
		<h4>상품 관리</h4>
		<ul>
	...
	<form action="register.do" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="userid" value="${sessionScope.aid}">
		<h3>| 상품 정보 입력</h3>
		<div>
		...
		<div id="t1PC" class="tabcontent tabcontent1">
			<table>
				...
				<tr>
					...
					<td style="width: 70%">
						<input type="file" name="pcmain1"><br>
						<input type="file" name="pcmain2"><br>
						<input type="file" name="pcmain3"><br>
						<input type="file" name="pcmain4">
					</td>
				</tr>
				<tr>
					<td style="width: 30%; text-align: right;">
		...
		<div id="t1Mobile" class="tabcontent tabcontent1">
			<table>
				...
				<tr>
					...
					<td style="width: 70%">
						<input type="file" name="mobilemain1"><br>
						<input type="file" name="mobilemain2"><br>
						<input type="file" name="mobilemain3"><br>
						<input type="file" name="mobilemain4">
					</td>
				</tr>
				<tr>
					<td style="width: 30%; text-align: right;">
