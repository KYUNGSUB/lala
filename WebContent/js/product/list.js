$(function() {
	...
	$("input[type='submit']").on("click", function(e) {
		...
		if($("#searchArea table").css("display") == "block") {	// 상세 검색을 요청하면
			...
			if($("input:checkbox[name='expose']").is(":checked") == false) {
				alert("진열 여부를 선택하세요.");
				$("input:checkbox[name='expose']").focus();
				return;
			}
