...
$(function() {
	...
	$(".delFile").on("click", function(e) {
		...
		if(confirm("정말로 삭제하시겠습니까?")) {
			...
			$tdTag.html("");		// 이미지를 보여주는 부분을 삭제
			var $inputTag = $tdTag.next().children();
			$inputTag.prop("disabled", false);	// 파일 추가 부분 활성화
		}
	});
});